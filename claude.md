...
~44k rows. Columns: `skill_id, prereq_id, source`

Sources: `khan` (1.5k), `alcpl` (1.9k), `metacademy` (1k), `esco` (189), `opensalt` (55), `mooccubex` (2.3k), `junyi_hierarchy` (19k), `junyi_logs` (16k), `assistments_logs` (1.8k)
